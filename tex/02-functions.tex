...
\begin{frame}[fragile,fragile]
  ...
  For the purpose of evaluating the truth value of an expression,
  the following rules apply:
  \begin{itemize}
  \item \texttt{False}, \texttt{0}, \lstinline|''| (empty string), and
    \emph{any empty sequence} evaluate to boolean \lstinline|False|;
  \item any other value is converted to \lstinline|True|.
  \end{itemize}

  \+
  You can always check the truth value of an expression with the
  \lstinline|bool| function:
