...
\end{python}
    ...
    \begin{column}{0.3\linewidth}
      \href{https://raw.githubusercontent.com/riccardomurri/python-for-science-intro/master/solutions/ex2a.py}{Download} this code into a file named \texttt{ex2a.py}
...
\begin{frame}[fragile]
  ...
  \begin{exercise*}[10.B]
    ...
    \href{https://raw.githubusercontent.com/riccardomurri/python-for-science-intro/master/}{this
      URL}.)}
  \end{exercise*}
...
\begin{frame}[fragile]
  ...
  \begin{exercise*}[10.D]
    ...
    Edit the script from Exercise 2.B above and add the ability to process
  ...
  \+
  \begin{exercise*}[10.E]
    Edit the script from Exercise 2.D above and add the ability to
